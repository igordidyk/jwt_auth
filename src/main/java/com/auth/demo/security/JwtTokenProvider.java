...
public class JwtTokenProvider {
    ...
    @Autowired
    public JwtTokenProvider(CustomUserDetails userDetails) {
    ...
    public String createTocken(String username, List<Role> roles) {
        ...
        Date validDate = new Date(currentDate.getTime() + validityInMilliseconds);
